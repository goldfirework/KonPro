poengsum = 0
def question(type, question, answer1, answer2, answer3, answer4, riktig, range, poeng):
...
poengsum = poengsum + question(2, "Hva er en velosiped", "Ord for fart", "Ord for akselerasjon", "En sykkel", 0, 3, 0, 1)
